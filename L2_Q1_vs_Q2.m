...
figure
loglog(hQ2,errQ2,'r-o',hQ1,errQ1,'b--*', hQ1,0.001*hQ1,'b:',hQ2, 0.1*(hQ2.^2),'r--');
xlabel('h = sqrt(sum(element sides squared))')
ylabel('error')
legend('FEM-Q2','FEM-Q1','O(h)','O(h^2)','Location','northwest')
title('25-100 Q2 VS 100-400 Q1 (2D) elements')
