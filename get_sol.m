function u = get_sol(msh, sz_u_field, dir_bndry_nodes, dir_bndry_val, problem_type)
...
%output: u: Solution u generated by solver
    ...
    %get the known u vector and global to local mapping for each u
    ...
    while((global_res_norm > 1.0e-9) && iter < max_iter)
        ...
        global_res = get_global_res(u, global_idx_map, msh, dir_bndry_val, problem_type);          
        ...
        fun = @(u)get_global_res(u, global_idx_map, msh, dir_bndry_val, problem_type);
