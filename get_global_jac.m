function global_jac = get_global_jac(dlta_u, global_idx_map, msh,num_quadr_pts_in_1d, userdf)
...
%
% output: global_jac: the action of consistant tangent on dlta_u
%               
     ...
     global_jac =zeros(size(dlta_u,1),1);
     ...
     for i=1:num_elem
         ...
         kk =in_glb(in_glb>=0);
         global_jac(kk) = global_jac(kk)+ jac_e(in_glb>=0);    
     end
end